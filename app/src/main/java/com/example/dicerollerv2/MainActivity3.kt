...
class MainActivity3 : AppCompatActivity() {
    ...
    private fun populateRollList(rollValue: Int, modificator: Int?) {
        ...
        db.collection("diceRolls").document(appId).collection("rolls").document()
            ...
            .addOnSuccessListener { Log.d(ContentValues.TAG, "Added to database") }
            .addOnFailureListener {e -> Log.w(ContentValues.TAG, "Error writing to database", e)}
    }
